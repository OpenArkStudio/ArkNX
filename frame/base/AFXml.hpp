...
namespace ark
{
    ...
    public:
        ...
        uint32_t GetUint32(const char* key, bool optional = false, uint32_t default_value = 0)
        {
            rapidxml::xml_node<>* node = reinterpret_cast<rapidxml::xml_node<>*>(xml_node_);
        ...
        float GetFloat(const char* key, bool optional = false, float default_value = 0.0f)
        {
            rapidxml::xml_node<>* node = reinterpret_cast<rapidxml::xml_node<>*>(xml_node_);
        ...
        std::string GetString(const char* key, bool optional = false, std::string default_value = "")
        {
            rapidxml::xml_node<>* node = reinterpret_cast<rapidxml::xml_node<>*>(xml_node_);
